...
- **Supabase Auth email templates** (signup confirmation, password reset, magic link) — Dashboard → Authentication → Email Templates. Add the same legal footer line to the signup confirmation and password-reset templates at minimum.
